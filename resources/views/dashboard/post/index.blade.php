...
<div class="max-w-5xl mx-auto px-4">
  ...
  <form method="POST" action="/dashboard/post/delete">
    ...
    <div class="py-2">
      ...
      <button class="text-blue-700 font-bold focus:outline-none py-2 px-4 mr-2 border border-blue-700 rounded" type="submit" name="checked_posts" value="checked_posts" onClick="delete_alert(event);return false;">適用</button>
    </div>
