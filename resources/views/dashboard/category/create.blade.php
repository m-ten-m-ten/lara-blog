...
<div class="max-w-5xl mx-auto px-4">
  <form method="POST" action="/dashboard/category/store" enctype='text'>
    @csrf
    <div class="flex justify-between items-center border-b">
      <div class="flex items-center">
      <h1 class="text-2xl font-bold py-4 mr-2">カテゴリー追加</h1>
    ...
    <div class="flex flex-wrap">
      <div class="py-2">
        ...
        <div class="py-3">
          ...
          <input name="category_title" class="my-2 px-2 py-2 border @error('category_title') border-red-500 @enderror rounded w-full text-xl" type="text" value="{{ old('category_title') }}">
        ...
        <div class="py-3">
          ...
          <input name="category_name" class="my-2 px-2 py-2 border @error('category_name') border-red-500 @enderror rounded w-full text-xl" type="text" value="{{ old('category_name') }}">
