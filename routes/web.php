...
Route::group(['middleware' => ['auth']], function (): void {
    ...
    Route::prefix('dashboard/post')->group(function (): void {
    ...
    Route::prefix('dashboard/image')->group(function (): void {
    ...
    Route::prefix('dashboard/category')->group(function (): void {
    ...
    Route::prefix('dashboard/tag')->group(function (): void {
